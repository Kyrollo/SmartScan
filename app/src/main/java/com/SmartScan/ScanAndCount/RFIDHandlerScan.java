...
public class RFIDHandlerScan implements IDcsSdkApiDelegate, Readers.RFIDReaderEventHandler {
    ...
    void onCreate(ScanAndCount activity) {
        context = activity;
